...
class practicaDemoUSRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "practicaDemoUSRP")
        ...
        self._k_imag_range = Range(0, 1, 1, 0, 200)
        self._k_imag_win = RangeWidget(self._k_imag_range, self.set_k_imag, "'k_imag'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._k_imag_win)
        self._fc_range = Range(50000000, 2.2e9, 1e6, 50e6, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "'fc'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._GTX_range = Range(0, 31, 1, 1, 200)
        ...
        self._GRX_range = Range(0, 30, 0.5, 1, 200)
        ...
        self.blocks_multiply_const_vxx_0_0_0 = blocks.multiply_const_ff(k_imag)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_ff(k_real)
        self.blocks_float_to_complex_0 = blocks.float_to_complex(1)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 4000, 1/2, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, 1/2, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_multiply_const_vxx_0_0_0, 0))
    ...
    def set_k_imag(self, k_imag):
        self.k_imag = k_imag
        self.blocks_multiply_const_vxx_0_0_0.set_k(self.k_imag)
...
def main(top_block_cls=practicaDemoUSRP, options=None):
