...
# Title: Primera Practica Ancho de Banda
...
class Primerapractica_H1G1(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Primera Practica Ancho de Banda", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Primera Practica Ancho de Banda")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Primerapractica_H1G1")
        ...
        self._N0_range = Range(1e-6, 500e-3, 1e-6, 1e-3, 200)
        ...
        self._GTX_range = Range(0, 30, 1, 6, 200)
...
def main(top_block_cls=Primerapractica_H1G1, options=None):
