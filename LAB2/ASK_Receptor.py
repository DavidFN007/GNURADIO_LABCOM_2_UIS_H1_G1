...
class ASK_Receptor(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ASK_Receptor")
        ...
        self._fa_range = Range(0, 781.25e3, 1.5625e3, 390.625e3, 200)
        self._fa_win = RangeWidget(self._fa_range, self.set_fa, "frecuencia del filtro", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fa_win)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.fa, 10e3, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=ASK_Receptor, options=None):
