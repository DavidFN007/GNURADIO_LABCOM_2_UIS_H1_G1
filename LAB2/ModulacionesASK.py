...
# Title: Modulaciones ASK
# Author: Jorge y David
# Copyright: UIS
...
class ModulacionesASK(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Modulaciones ASK", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Modulaciones ASK")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ModulacionesASK")
        ...
        # Blocks
        ##################################################
        self._ka_range = Range(0, 2, 100e-3, 1, 200)
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganacia transmisor", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._GTX_win)
        self._Ac_range = Range(0, 2, 1e-1, 0.1, 200)
...
def main(top_block_cls=ModulacionesASK, options=None):
